...
$question_text = "I find women who play volleyball to be more feminine than women who play basketball.";
...
<html>
  ...
  <body>
    <form method="post" action="q6.php">
        ...
        <?php echo '<p><input type="hidden" name="question" value="QUES_5" /></p>'; ?>
