...
$question_text = "I think drop earrings are a “woman’s” accessory and should not be worn by other gender groups.";
...
<html>
  ...
  <body>
    <form method="post" action="q10.php">
        ...
        <?php echo '<p><input type="hidden" name="question" value="QUES_9" /></p>'; ?>
