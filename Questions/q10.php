...
$question_text = "I think makeup is a “woman’s” thing and should not be worn by other gender groups.";
...
<html>
  ...
  <body>
    <form method="post" action="q11.php">
        ...
        <?php echo '<p><input type="hidden" name="question" value="QUES_10" /></p>'; ?>
