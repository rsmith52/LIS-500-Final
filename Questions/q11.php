...
$question_text = "I think thigh-length shorts look less masculine on men than knee-length shorts.";
...
<html>
  ...
  <body>
    <form method="post" action="q12.php">
        ...
        <?php echo '<p><input type="hidden" name="question" value="QUES_11" /></p>'; ?>
