...
$question_text = "I believe men do not care about their appearance as much as other gender groups do.";
...
<html>
  ...
  <body>
    <form method="post" action="q15.php">
        ...
        <?php echo '<p><input type="hidden" name="question" value="QUES_14" /></p>'; ?>
